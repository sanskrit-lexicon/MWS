...
| [`cross_dict_kernel.py`](cross_dict_kernel.py) | [CROSS_DICT.md](CROSS_DICT.md) | [D1](../DOUBTS.md#d1--is-block-economy-a-genuine-principle-or-print-economic-artifact--important) | Format-robust block-economy *shape* comparison across all eight dictionaries. |
