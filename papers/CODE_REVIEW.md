...
| # | file | finding | tier |
|---|---|---|---|
| 1 | [register_b_dcs.py:35](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L35) | `ITI_RE` char class eats a literal hyphen → `rAja-` fails KOSA test | 🔴 |
| 2 | [register_b_dcs.py:35](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L35) | `ITI_RE` needs a leading space → body-line-start `iti` dropped | 🔴 |
| 3 | [register_b_dcs.py:58](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L58) | `attested()` strips final SLP1 `M` unconditionally → `kiM` false-matches | 🔴 |
| 4 | [root_crosswalk.py:67](https://github.com/sanskrit-lexicon/MWS/blob/master/root_crosswalk/root_crosswalk.py#L67) | anchors built from ALL whitneyroots, not `verb=genuineroot` → 813 > 750 | 🟡 |
| 5 | [class_concordance.py:94](https://github.com/sanskrit-lexicon/MWS/blob/master/root_crosswalk/class_concordance.py#L94) | `N = len(records)` double-counts ~50 homonym roots | 🟡 |
| 6 | [ls_L_dcs2026.py:118](https://github.com/sanskrit-lexicon/MWS/blob/master/lexicographer_dcs/ls_L_dcs2026.py#L118) | 2026 side of stability line hardcodes `31.4%` while 2021 is computed | 🟠 |
| 7 | [register_b_dcs.py:159](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L159) | prose numbers hardcoded literals next to live-computed table cells | 🟠 |
| 8 | [ib_resolve.py:14](https://github.com/sanskrit-lexicon/MWS/blob/master/relative_refs/ib_resolve.py#L14) | docstring describes OLD k1-cluster algorithm; code resolves globally | 🟡 |
| 9 | [phw_audit.py:95](https://github.com/sanskrit-lexicon/MWS/blob/master/phw_graph/phw_audit.py#L95) | one broken pair counted as two issues (asymmetric + orphan_backlink) | 🟡 |
| 10 | [phw_audit.py:81](https://github.com/sanskrit-lexicon/MWS/blob/master/phw_graph/phw_audit.py#L81) | missing-backlink bucketed as `asymmetric`, same as wrong-parent MISMATCH | 🟡 |
| 11 | [build_packets.py:143](https://github.com/sanskrit-lexicon/MWS/blob/master/review_packets/build_packets.py#L143) | Packet C `setdefault` keeps FIRST homonym; conflict sits on a later one | 🟡 |
| 12 | [ib_resolve.py:39](https://github.com/sanskrit-lexicon/MWS/blob/master/relative_refs/ib_resolve.py#L39) | `re.split(..., 1)` positional maxsplit → DeprecationWarning on 3.14 | 🟢 |
| 13 | [register_b_dcs.py:91](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L91) | `n_records` re-reads source file to count `<L>`; leaks bare `open()` handle | 🟢 |
| 14 | [ls_L_dcs2026.py:44](https://github.com/sanskrit-lexicon/MWS/blob/master/lexicographer_dcs/ls_L_dcs2026.py#L44) | IAST→SLP1 `_MAP` diverged from `link_candidates.py` copy | 🟢 |
| 15 | [ib_resolve.py:36](https://github.com/sanskrit-lexicon/MWS/blob/master/relative_refs/ib_resolve.py#L36) | META `non-text citation` set defined inconsistently across siblings | 🟢 |

## 🔴 Changes a published number

**1. `ITI_RE` hyphen capture.** [register_b_dcs.py:35](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L35) —
...
**2. `ITI_RE` leading-space requirement.** [register_b_dcs.py:35](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L35) —
...
**3. `attested()` over-strips final anusvāra.** [register_b_dcs.py:58](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L58) —
...
**6. Hardcoded 2026 stability figure.** [ls_L_dcs2026.py:118](https://github.com/sanskrit-lexicon/MWS/blob/master/lexicographer_dcs/ls_L_dcs2026.py#L118) —
...
**7. Hardcoded prose numbers beside a live table.** [register_b_dcs.py:159](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L159) —
...
**4. Anchors not filtered to genuine roots.** [root_crosswalk.py:67](https://github.com/sanskrit-lexicon/MWS/blob/master/root_crosswalk/root_crosswalk.py#L67) —
...
**5. Concordance N counts records, not roots.** [class_concordance.py:94](https://github.com/sanskrit-lexicon/MWS/blob/master/root_crosswalk/class_concordance.py#L94) —
...
**8. Stale docstring vs global resolver.** [ib_resolve.py:14](https://github.com/sanskrit-lexicon/MWS/blob/master/relative_refs/ib_resolve.py#L14) —
...
**9. One broken pair double-counted.** [phw_audit.py:95](https://github.com/sanskrit-lexicon/MWS/blob/master/phw_graph/phw_audit.py#L95) —
...
**10. Missing-backlink mislabelled as asymmetric.** [phw_audit.py:81](https://github.com/sanskrit-lexicon/MWS/blob/master/phw_graph/phw_audit.py#L81) —
...
**11. Packet C shows the wrong homonym.** [build_packets.py:143](https://github.com/sanskrit-lexicon/MWS/blob/master/review_packets/build_packets.py#L143) —
...
**12. Positional `maxsplit` deprecation.** [ib_resolve.py:39](https://github.com/sanskrit-lexicon/MWS/blob/master/relative_refs/ib_resolve.py#L39) —
...
**13. Redundant re-read + leaked handle.** [register_b_dcs.py:91](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/register_b/register_b_dcs.py#L91) —
...
**14. Diverged IAST→SLP1 map.** [ls_L_dcs2026.py:44](https://github.com/sanskrit-lexicon/MWS/blob/master/lexicographer_dcs/ls_L_dcs2026.py#L44) —
...
**15. Inconsistent META citation set.** [ib_resolve.py:36](https://github.com/sanskrit-lexicon/MWS/blob/master/relative_refs/ib_resolve.py#L36) —
