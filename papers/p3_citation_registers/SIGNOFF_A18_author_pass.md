...
1. American spelling (artefact→artifact, digitisation→digitization, characterisable, normalisation, defence, programme, catalogue, capitalised — 14 tokens; verifier round 1 caught two more, neighbour and travelled, plus "New edn." → "New ed." and one period-outside-quote — fixed in the follow-up PR; round 2 found five more period/comma-outside-quote cases, fixed in a second follow-up).
