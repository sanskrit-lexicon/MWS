...
## Headline
- **5,935 of 18,930 (31.4%) attested in DCS-2026** — up from 5,871 (31.0%) on DCS-2021.
- Net new refutations vs 2021: **+64**.
...
- The headline barely moves across two DCS snapshots:
  **31.0% (DCS-2021) -> 31.4% (DCS-2026)**. NB these are two versions of
...
- Transcoder validated: only **11 of 5,871** 2021 hits are absent in 2026
  (0.2%, plain-ASCII SLP1 so not a transcode failure — DCS
  lemmatisation drift), against **+75 gross new gains**. A broken IAST->SLP1 join would
...
- DCS-2026 has ~90,349 distinct occurring lemmas vs ~83k in the 2021
