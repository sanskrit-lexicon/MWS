...
- **A18 re-sync + Dictionaries venue fit** (Fable 5.1 `claude-fable-5-1`, 24-09-2026, [H5326](https://github.com/gasyoun/Uprava/blob/main/handoffs/H5326-Fable_MWS_a18-p3-citation-registers-author-pass_23.09.26.md), [PR #303](https://github.com/sanskrit-lexicon/MWS/pull/303)): [A18_citation_registers_paper.md](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/A18_citation_registers_paper.md) §2/§6/§7 atlas figures re-synced to the `csl-atlas` artifact regenerated by [csl-atlas #266](https://github.com/sanskrit-lexicon/csl-atlas/pull/266) (17-07-2026) — the §6.2 undercount the draft reported had been adopted upstream corpus-wide the day after the draft, so the paper carried pre-fix numbers (1,245,644 / 59.3 %) for ten weeks; §6.2 now reads as an adopted correction with a before/after table; `mw.txt` source pinned to csl-orig `de8c186` and the census re-run identical against head `f4c08c5`; style-sheet fit (US spelling, closed em dashes, Tables 1–4, single-quoted glosses, author-date cites + §10 References). Receipts and remaining human rulings: [SIGNOFF_A18_author_pass.md](https://github.com/sanskrit-lexicon/MWS/blob/master/papers/p3_citation_registers/SIGNOFF_A18_author_pass.md) §4.
