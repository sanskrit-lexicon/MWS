#-*- coding:utf-8 -*-
"""mw_transcoder2.py
 Revised to use transcoder1 directory for transcoder xml files.
 This due to change in accents. 
 Revised from mw_transcoder1.py at 12-12-2022.
  Only change
"""
from __future__ import print_function
import sys, re,codecs
import transcoder
transcoder.transcoder_set_dir('transcoder1')
...
def convert_metaline(line,tranin,tranout):
 ...
 if (tranin in ['roman','roman1']) and (tranout == 'slp1'):
  ...
  exceptions = [
   ('<L>116525.7<',
    '<L>116525.7<pc>588,2<k1>paramahaMsopanizadhfdaya<k2>parama—haMsopanizad-hfdaya<e>4',  # remove accent at commit b42685b of csl-orig/v02/mw/mw.txt
