#-*- coding:utf-8 -*-
"""change2e.py change transactions re panini links
...
def init_changes(lines):
 ...
 """
 regexraw3 = r'<ls>Pāṇ[.] ([0-9]+)-([0-9]+), ([0-9]+) and ([0-9]+), ([0-9]+)([,.;]?)</ls>'
 ...
 for iline,line in enumerate(lines):
  ...
  if line.startswith('[Page'):
   ...
   continue
  oldline = line
  newline = re.sub(regex3,
    r'<ls>Pāṇ. \1-\2, \3</ls> and <ls n="Pāṇ. \1">\4, \5</ls>\6',line)
  if newline == oldline:
   continue
  reason = None
