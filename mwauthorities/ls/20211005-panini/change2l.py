#-*- coding:utf-8 -*-
"""change2l.py change transactions re panini links
...
def init_changes(lines):
 ...
 """
 regexraw3 = r'<ls>Pāṇ[.] ([0-9]+)-([0-9]+, [0-9]+) *; *([0-9]+) *, *([0-9]+) *([.,]?) *</ls>'
 regex3 = re.compile(regexraw3)
 ...
 for iline,line in enumerate(lines):
  ...
  if line.startswith('[Page'):
   ...
   continue
  oldline = line
  newline = re.sub(regex3,r'<ls>Pāṇ. \1-\2</ls>; <ls n="Pāṇ. \1">\3, \4</ls>\5',line)
  if newline == line:
   continue
  reason = None
