#-*- coding:utf-8 -*-
"""ls_abbrev_instances1.py  similar to ls_abbrev_instances.py
"""
...
def write_cases(fileout,abbrevdict,abbrevlist):
 ...
 outrecs = []
 totcases = 0
 for abbrevrec in abbrevlist:
  abbrev = abbrevrec.abbrev
  cases = abbrevdict[abbrev]
  ncases = len(cases)
  totcases = totcases + ncases
  outarr = []
  outarr.append('; ======================================================')
  outarr.append('; %s %s instances' % (abbrev,ncases))
  outarr.append(';; %s' %abbrevrec.line)
  outarr.append('; ======================================================')
 ...
 with codecs.open(fileout,"w","utf-8") as f:
  for outarr in outrecs:
   for out in outarr:
    f.write(out+'\n')
 print(totcases,'cases written to',fileout)
...
if __name__=="__main__":
 ...
 with codecs.open(filein1,"r","utf-8") as f:
  abbrevlist = [Abbrev(x) for x in f]
