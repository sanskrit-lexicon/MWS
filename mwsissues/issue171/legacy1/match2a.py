...
import digentry
from match2 import init_forcematch,get_forcematch_k1
...
def check1a_entries(entries,k1dict,forcerecs):
 probs = [] # no match 
 for entry in entries:  # mw.txt
  ...
  if revsup == None:
   continue
  k1 = entry.metad['k1']
  forcerec = get_forcematch_k1(k1,forcerecs,'mw')
  if forcerec != None:
   # no problem
   continue  
  if k1 not in k1dict:
...
if __name__=="__main__":
 ...
 problems1 = check1a_entries(entries,k1dict,forcerecs)
