...
if __name__=="__main__":
 filein = sys.argv[1] # lla1
 fileout = sys.argv[2] # simple diffs
 lines = read_lines(filein)
 groups = list(get_linegroups(lines))
 print(len(groups),"groups")
 #
 simplegroups = get_simplegroups(groups)
 print(len(simplegroups),"simple groups")
 #
 simplediffs = get_simplediffs(simplegroups)
 print(len(simplediffs),"TODO among simplediffs")
 #
 write_recs(fileout,simplediffs)
