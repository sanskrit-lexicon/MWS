...
if __name__ == "__main__":
 file1 = sys.argv[1]  # kosha
 file2 = sys.argv[2]  # headwords 
 fileout = sys.argv[3] # headwords in kosha?
 wordset1 = init_wordset(file1)  # distinct headwords in kosha
 lines2 = read_lines(file2)   # headwords in file2
 wordset2 = set(lines2)
 wordset3 = wordset2.difference(wordset1)
 words3 = list(wordset3)
 outarr = make_outarr(words3)
