...
| `MW.` | Words/meanings **given on Monier-Williams' authority** (not a literary work). Per the 1899 Introduction: many from commentaries or notes after conversations with pandits (p. xviii); **some rest on the *Śabda-kalpa-druma* (SKD)** of Rādhākānta Deva (p. xxxii); some from his own books. **Not** a self-citation of the 1872 first edition — that reading (and the Cologne `mwauthorities` expansion "1st edition with marginal notes") is a mechanical misread of the siglum | 5,711 | Authority mark (SKD / pandit notes / own books) |
